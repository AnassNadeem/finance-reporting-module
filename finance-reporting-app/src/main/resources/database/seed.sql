...
('SUPER_ADMIN', 'MANAGE_FINANCE_DATA'),
('SUPER_ADMIN', 'EXPORT_REPORTS'),
('SUPER_ADMIN', 'MANAGE_USERS');

-- FINANCE ADMIN (Team Leads)
INSERT OR IGNORE INTO role_permissions (role, action) VALUES
('FINANCE_ADMIN', 'VIEW_DASHBOARD'),
('FINANCE_ADMIN', 'MANAGE_FINANCE_DATA'),
('FINANCE_ADMIN', 'EXPORT_REPORTS');

-- FINANCE USER (Analysts)
INSERT OR IGNORE INTO role_permissions (role, action) VALUES
('FINANCE_USER', 'VIEW_DASHBOARD'),
('FINANCE_USER', 'MANAGE_FINANCE_DATA');

-- VIEWER (Trainees / Other departments)
INSERT OR IGNORE INTO role_permissions (role, action) VALUES
